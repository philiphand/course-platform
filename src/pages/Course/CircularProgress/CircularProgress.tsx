...
const CircularProgressBar = ({
    ...
    const renderPie = (i: number) => {
        ...
        const rotationAngle = DIRECTION * (initialAngularDisplacement ? initialAngularDisplacement : 0)
    ...
    const textValueY = label ? radius : radius + (valueFontSize ? valueFontSize : Math.floor(DEFAULT_RADIUS / 2.5)) / 3;
    ...
    return (
        <svg width={radius * 2} height={radius * 2}>
            ...
            <circle r={radius - (strokeWidth ? strokeWidth : (DEFAULT_RADIUS / 10))} cx={radius} cy={radius} fill={backgroundColor} />
